...
<title>Nari Site - ${messageVO.title}</title>
</head>
<body>
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						...
						<c:if test="${not empty messageVO.url}">
							<a href="<c:url value='${messageVO.url}' />" class="btn btn-warning"> <span class="glyphicon glyphicon-new-window aria-hidden="true">
							</span> &nbsp;${messageVO.urlTitle}
							</a>
						</c:if>
					</div>
				</div>
